...
function SHA1(string) {
    ...
    var H = [0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0],
        ...
        lb, hb, string_length, pad, string_length_bytes, blocks, b, block, bl, words, i, A, B, C, D, E, t, n, TEMP;
    ...
    string_length_bytes = [((hb * 8) >> 24) & 255, ((hb * 8) >> 16) & 255, ((hb * 8) >> 8) & 255, (hb * 8) & 255, ((lb * 8) >> 24) & 255, ((lb * 8) >> 16) & 255, ((lb * 8) >> 8) & 255, (lb * 8) & 255];
