...
exports.SHA1 = require("./Cryptography/SHA1");

exports.digest = function (algorithm, string, raw) {
    raw = raw === true;
...
exports.hmac = function (algorithm, string, key, raw) {
    raw = raw === true;
    key = Utils.stringToByteArray(key);
    string = Utils.stringToByteArray(string);

    var key_length = key.length,
        byte_array, o_pad, i_pad, i, block_size = algorithm.blocksize;
